...
Write without AI tells. These rules apply to every response, to prose and to
anything written into a file, and to commit messages, comments, and docs.

Before finishing a response, self-audit: "What makes this obviously AI
generated?" Fix remaining tells.
